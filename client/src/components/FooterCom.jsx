    ...
    <Footer container className='border border-t-8 border-teal-500'>
      <div className='w-full max-w-7xl mx-auto'>
        <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
          <div className='mt-5'>
              <Link to={"/"} className='self-center whitespace-nowrap text-lg sm:text-xl dark:text-white font-semibold my-2'>
          ...
          <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
            ...
            <div>
                ...
                <Footer.LinkGroup col>
                  <Footer.Link href='https://www.linkedin.com/in/gurkirat-singh-25b024289/' target='_blank' rel='noopener noreferrer'>LinkedIn</Footer.Link>
                  <Footer.Link href='https://www.linkedin.com/in/gurkirat-singh-25b024289/' target='_blank' rel='noopener noreferrer'>Instagram</Footer.Link>
                </Footer.LinkGroup>
            </div>
            <div>
              <Footer.Title title='Follow us'></Footer.Title>
                <Footer.LinkGroup col>
                  <Footer.Link href='https://www.linkedin.com/in/gurkirat-singh-25b024289/' target='_blank' rel='noopener noreferrer'>Github</Footer.Link>
        ...
        <div className='w-full sm:flex sm:items-center sm:justify-between'>
          <Footer.Copyright href='#' by='Mern Blogs' year={new Date().getFullYear()}></Footer.Copyright>
